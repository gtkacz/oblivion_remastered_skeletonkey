...
---@class FWidgetChild
---@field WidgetName FName
---@field WidgetPtr TWeakObjectPtr<UWidget>
local FWidgetChild = {}
...
---@field VOnFocusLost FEditableTextVOnFocusLost
---@field VOnFocusReceived FEditableTextVOnFocusReceived
local UEditableText = {}

function UEditableText:VOnFocusEvent__DelegateSignature() end
...
---@field ScrollBarDisabledVisibility ESlateVisibility
---@field MinimalThumbSize float
---@field bIsUsingShadow boolean
---@field ShadowStyle FScrollBoxStyle
---@field ListItems TArray<UObject>
---@field HorizontalEntrySpacing float
---@field VerticalEntrySpacing float
...
---@field BP_OnListViewScrolled FListViewBP_OnListViewScrolled
local UListView = {}

---@param NewBrush FScrollBoxStyle
function UListView:SetShadowBrush(NewBrush) end
...
---@param NewScrollBarDisabledVisibility ESlateVisibility
function UListView:SetScrollBarDisabledVisibility(NewScrollBarDisabledVisibility) end
---@param NewMinimalThumbSize float
function UListView:SetMinimalThumbSize(NewMinimalThumbSize) end
---@param NewState boolean
function UListView:SetIsUsingShadow(NewState) end
---@param Index int32
...
---@param NewScrollBarDisabledVisibility ESlateVisibility
function UScrollBox:SetScrollBarDisabledVisibility(NewScrollBarDisabledVisibility) end
...
---@param NewMinimalThumbSize float
function UScrollBox:SetMinimalThumbSize(NewMinimalThumbSize) end
...
---@field bEntrySizeIncludesEntrySpacing boolean
local UTileView = {}
...
---@field DesiredFocusWidget FWidgetChild
...
---@field PixelSnapping EWidgetPixelSnapping
...
---@class UWidgetBinaryStateRegistration : UObject
local UWidgetBinaryStateRegistration = {}
...
---@class UWidgetDisabledStateRegistration : UWidgetBinaryStateRegistration
local UWidgetDisabledStateRegistration = {}


---@class UWidgetEnumStateRegistration : UObject
local UWidgetEnumStateRegistration = {}
...
---@class UWidgetStateSettings : UDeveloperSettings
local UWidgetStateSettings = {}
