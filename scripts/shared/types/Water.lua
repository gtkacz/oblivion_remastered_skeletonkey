...
---@field WaterInfoMeshComponent UWaterBodyInfoMeshComponent
---@field DilatedWaterInfoMeshComponent UWaterBodyInfoMeshComponent
---@field WaterBodyStaticMeshComponents TArray<UWaterBodyStaticMeshComponent>
local AWaterBody = {}
...
---@field bEnableLocalOnlyTessellation boolean
---@field LocalTessellationExtent FVector
local AWaterZone = {}
...
---@field TargetComponentReference FComponentReference
---@field MaxLocalPositionCorrection FVector
...
---@class FWaterBodyStaticMeshSettings
---@field bEnableWaterBodyStaticMesh boolean
---@field bSectionWaterBodyStaticMesh boolean
---@field SectionSize double
local FWaterBodyStaticMeshSettings = {}
...
---@field WaterStaticMeshMaterial UMaterialInterface
---@field UnderwaterPostProcessMaterial UMaterialInterface
...
---@field StaticMeshSettings FWaterBodyStaticMeshSettings
---@field WaterBodyIndex int32
...
---@field WaterStaticMeshMID UMaterialInstanceDynamic
...
---@field ShallowNavAreaClass TSubclassOf<UNavAreaBase>
---@field ShallowWaterInCentimeters float
...
---@class UWaterBodyInfoMeshComponent : UWaterBodyMeshComponent
local UWaterBodyInfoMeshComponent = {}
...
---@class UWaterBodyMeshComponent : UStaticMeshComponent
local UWaterBodyMeshComponent = {}
...
---@field OceanExtents FVector2D
---@field SavedZoneLocation FVector2D
...
---@class UWaterBodyStaticMeshComponent : UWaterBodyMeshComponent
local UWaterBodyStaticMeshComponent = {}
...
---@field bUseFarMeshWithoutOcean boolean
...
---@field ShallowWaterNavAreaClass TSubclassOf<UNavAreaBase>
---@field bWarnOnMismatchOceanExtent boolean
