...
local EBlendSpacePerBoneBlendMode = {
...
local EDataDrivenShaderPlatformInfoCondition = {
    COND_True = 0,
    COND_False = 1,
    COND_Max = 2,
}
...
---@enum EDecalChannels
local EDecalChannels = {
    None = 0,
    Channel0 = 1,
    Channel1 = 2,
    Channel2 = 4,
    EDecalChannels_MAX = 5,
}
...
local ENavigationInvokerPriority = {
    VeryLow = 1,
    Low = 2,
    Default = 3,
    High = 4,
...
local ENavigationSortPendingTilesMethod = {
...
local ENonSpatializedRadiusSpeakerMapMode = {
    OmniDirectional = 0,
    Direct2D = 1,
    Surround2D = 2,
...
local EPathTracingBufferTextureId = {
    PTBT_Radiance = 0,
...
local EShadowCacheInvalidationBehavior = {
    Auto = 0,
    Always = 1,
    Rigid = 2,
    Static = 3,
...
local ESkeletalMeshVertexAttributeDataType = {
    Float = 0,
    HalfFloat = 1,
    NUInt8 = 2,
...
local EStreamingSourceTargetBehavior = {
    Include = 0,
    Exclude = 1,
...
local ESwitchMaterialOutputType = {
    TMMOT_Float1 = 0,
    TMMOT_Float2 = 1,
    TMMOT_Float3 = 2,
    TMMOT_Float4 = 3,
...
local EViewStatusForScreenPercentage = {
    NonRealtime = 0,
    Desktop = 1,
    Mobile = 2,
    VR = 3,
...
local EWorldPartitionCVarProjectDefaultOverride = {
    ProjectDefault = 0,
    Disabled = 1,
    Enabled = 2,
...
local EWorldPartitionServerStreamingMode = {
    ProjectDefault = 0,
    Disabled = 1,
    Enabled = 2,
    EnabledInPIE = 3,
...
local EWorldPartitionServerStreamingOutMode = {
    ProjectDefault = 0,
    Disabled = 1,
    Enabled = 2,
...
local TextureCookPlatformTilingSettings = {
