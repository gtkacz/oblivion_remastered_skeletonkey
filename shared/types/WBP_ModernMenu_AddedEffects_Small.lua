...
---@class UWBP_ModernMenu_AddedEffects_Small_C : UCommonUserWidget
...
local UWBP_ModernMenu_AddedEffects_Small_C = {}

function UWBP_ModernMenu_AddedEffects_Small_C:SetPropertiesText() end
function UWBP_ModernMenu_AddedEffects_Small_C:SetPropertiesVisibility() end
---@param NewProperties FModernEffectItemData
function UWBP_ModernMenu_AddedEffects_Small_C:SetProperties(NewProperties) end
---@param ListItemObject UObject
function UWBP_ModernMenu_AddedEffects_Small_C:OnListItemObjectSet(ListItemObject) end
---@param EntryPoint int32
function UWBP_ModernMenu_AddedEffects_Small_C:ExecuteUbergraph_WBP_ModernMenu_AddedEffects_Small(EntryPoint) end
