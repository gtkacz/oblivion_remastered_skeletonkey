...
---@field DecalChannels EDecalChannels
...
---@field bEnableDiscardOnLoad boolean
---@field bEnableCullDistanceScaling boolean
...
---@field bUseOverrideFoliageTerrainMaterials boolean
---@field OverrideFoliageTerrainMaterials TArray<TSoftObjectPtr<UMaterialInterface>>
